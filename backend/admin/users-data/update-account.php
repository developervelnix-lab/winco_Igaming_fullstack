...
/* Page specific variable overrides only if needed */
        ...
        .total-label { font-size: 12px; color: var(--text-dim); font-weight: 500; }
        .total-value { font-size: 18px; font-weight: 800; }

        .btn-submit {
            width: 100%; height: 56px; background: linear-gradient(135deg, #3b82f6, #2563eb);
            border: none; border-radius: 14px; color: #ffffff; font-size: 16px; font-weight: 700;
            ...
            <form class="glass-card" action="<?php echo $_SERVER['PHP_SELF'].'?user-id='.$user_uniq_id; ?>" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" value="<?php echo $user_email_id; ?>" class="cus-inp" disabled>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="number" step="any" id="inp_balance_adjustment" placeholder="Add or subtract amount (e.g. 500 or -200)" class="cus-inp" onInput="updateBalancePreview()">
                    </div>
