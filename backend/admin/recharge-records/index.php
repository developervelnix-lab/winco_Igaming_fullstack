...
/* Page specific variable overrides only if needed */
        ...
        .btn-primary-modern { background: var(--accent-blue); color: #fff !important; }
        ...
        .cus-checkbox-group { display: flex; gap: 24px; align-items: center; }
    ...
    <div class="admin-main-content hide-native-scrollbar">
        ...
        <div class="dash-header">
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn-modern btn-primary-modern" onclick="exportPDF('recharge-records', 'recharge')"><i class='bx bxs-file-pdf'></i> Export PDF</button>
            </div>
        </div>
            ...
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div class="cus-checkbox-group mb-3">
                    <label class="cus-checkbox">
                        <input type="checkbox" name="order_type" value="success" <?php if($newRequestStatus == "success") echo "checked"; ?>>
                        <span>Show Success</span>
                    </label>
                    <label class="cus-checkbox">
                        <input type="checkbox" name="order_type" value="rejected" <?php if($newRequestStatus == "rejected") echo "checked"; ?>>
                        <span>Show Rejected</span>
                    </label>
                    <label class="cus-checkbox">
                        <input type="checkbox" name="order_type" value="pending" <?php if($newRequestStatus == "pending") echo "checked"; ?>>
        ...
        <div style="padding: 0 20px;">
                ...
                <tbody>
                    ...
                    ?>
                        <tr onclick="window.location.href='manager.php?uniq-id=<?php echo $row['tbl_uniq_id']; ?>'">
                            ...
                            <td style="color: var(--accent-emerald); font-weight: 800;">₹<?php echo number_format($row['tbl_recharge_amount'], 2); ?></td>
                            ...
                            <td style="font-size: 12px; color: var(--text-dim);"><?php echo $row['tbl_recharge_details']; ?></td>
                            <td style="text-align: right; font-weight: 700; color: var(--accent-blue);"><?php echo $row['tbl_recharge_mode']; ?></td>
                        </tr>
                    <?php 
                        $indexVal++;
                        } 
                        ...
                        <tr>
                            <td colspan="7" style="text-align: center; padding: 60px; color: var(--text-dim);">
                                <i class='bx bx-receipt' style="font-size: 48px; display: block; margin-bottom: 12px; opacity: 0.5;"></i>
            ...
            <?php
            $count_sql = "SELECT id FROM tblusersrecharge WHERE tbl_request_status='{$newRequestStatus}'";
            ...
            ?>
                <div class="pagination-container">
                    <div class="d-flex gap-2">
                        <?php if ($page_num > 1): ?>
                            <a href="?page_num=<?php echo $page_num-1; ?>&order_type=<?php echo $newRequestStatus; ?>" class="btn-modern btn-outline-modern">
