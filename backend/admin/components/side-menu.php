...
<div class="menu-bar-view hide-native-scrollbar">
    ...
    <div class="side-logo-area">
        ...
        <div class="d-flex gap-2">
            ...
            <div class="menu-open-btn menu-close-btn"><i class='bx bx-chevron-left'></i></div>
        </div>
    </div>
    ...
    echo 'menu-active-btn';
        ...
        <a href="<?php echo $host_url; ?>game" class="nav-link <?php if ($page_url_name == 'game') {
    echo 'menu-active-btn';
}?>">
            <i class='bx bx-joystick' style='color:#10b981;'></i>
            Control Matches
        </a>
