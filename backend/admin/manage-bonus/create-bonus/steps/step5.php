        ...
        <div class="col-md-11">
            ...
            foreach ($providers as $p) {
                ...
                <div class="row align-items-center mb-4">
                    <div class="col-md-4">
                        <span style="font-size: 14px; font-weight: 600; color: var(--text-main);"><?php echo $p; ?></span>
                    </div>
                    <div class="col-md-3">
                        <div class="toggle-group">
                            <button type="button" class="toggle-btn <?php echo $is_enabled ? 'active' : ''; ?>" data-val="yes">Yes</button>
                            <button type="button" class="toggle-btn <?php echo !$is_enabled ? 'active' : ''; ?>" data-val="no">No</button>
                            <input type="hidden" name="wagering_enabled[<?php echo $p; ?>]" value="<?php echo $is_enabled ? 'yes' : 'no'; ?>">
                        </div>
                    </div>
                    <div class="col-md-3 text-end">
                        <span style="font-size: 13px; color: var(--text-dim); font-weight: 600;">Wagering Multiplier</span>
                    </div>
                    <div class="col-md-2">
                        <input type="number" name="multiplier[<?php echo $p; ?>]" class="cus-inp" style="height: 40px;" placeholder="" value="<?php echo $multiplier_val; ?>">
                    </div>
                </div>
                <?php
            }
