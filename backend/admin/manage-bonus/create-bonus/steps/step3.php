<div id="step3" class="wizard-step-content" style="display: none;">
    <div class="row g-4">
        ...
        <div class="col-md-12">
            ...
            <textarea name="terms" class="cus-txt" style="height: 150px;" required placeholder="Detailed terms and conditions..."><?php echo $is_edit ? $bonus_content['terms_conditions'] : ''; ?></textarea>
        </div>
    </div>
