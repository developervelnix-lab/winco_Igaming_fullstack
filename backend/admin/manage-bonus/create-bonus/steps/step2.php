    ...
    <div class="row g-4">
        <div class="col-md-12">
            ...
            <select name="redemption_type" class="cus-sel" required>
                ...
                <option value="cashback_bonus" <?php echo ($is_edit && $bonus_data['redemption_type'] == 'cashback_bonus') ? 'selected' : ''; ?>>Cashback bonus</option>
        ...
        <div class="col-md-12 mt-4 d-flex align-items-center justify-content-between">
            ...
            <div class="toggle-group">
                ...
                <input type="hidden" name="is_first_deposit" value="<?php echo ($is_edit && $bonus_data['is_first_deposit']) ? 'yes' : 'no'; ?>">
            </div>
        </div>
        ...
        <div class="col-md-12 mt-4">
            ...
            <div class="row g-4">
                <div class="col-md-12 d-flex align-items-center justify-content-between">
                    ...
                    <input type="number" name="limit_daily" class="cus-inp" style="width: 200px;" placeholder="0" value="<?php echo $is_edit ? $bonus_data['limit_daily'] : '0'; ?>">
                </div>
                <div class="col-md-12 d-flex align-items-center justify-content-between">
                    <span style="font-size: 13px; color: var(--text-dim);">Per Week</span>
                    <input type="number" name="limit_weekly" class="cus-inp" style="width: 200px;" placeholder="0" value="<?php echo $is_edit ? $bonus_data['limit_weekly'] : '0'; ?>">
                </div>
                <div class="col-md-12 d-flex align-items-center justify-content-between">
                    <span style="font-size: 13px; color: var(--text-dim);">Per Month</span>
                    <input type="number" name="limit_monthly" class="cus-inp" style="width: 200px;" placeholder="0" value="<?php echo $is_edit ? $bonus_data['limit_monthly'] : '0'; ?>">
                </div>
                <div class="col-md-12 d-flex align-items-center justify-content-between">
                    <span style="font-size: 13px; color: var(--text-dim);">Maximum Coupon Redemptions</span>
                    <input type="number" name="limit_total" class="cus-inp" style="width: 200px;" placeholder="0" value="<?php echo $is_edit ? $bonus_data['limit_total'] : '0'; ?>">
                </div>
            </div>
        </div>
    </div>
