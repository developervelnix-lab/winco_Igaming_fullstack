...
try {
    if ($is_edit) {
        ...
        $sql = "INSERT INTO tbl_bonuses (
                name, type, coupon_code, status, is_published, is_public, comment, redemption_type, amount, 
                ...
                '$name', '$type', '$coupon_code', 'active', $is_published, $is_public, '$comment', '$redemption_type', 
