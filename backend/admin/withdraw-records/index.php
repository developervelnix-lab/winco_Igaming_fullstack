...
/* Page specific variable overrides only if needed */
        ...
        .tag-success { background: rgba(16, 185, 129, 0.1); color: var(--status-success); }
        .tag-danger { background: rgba(244, 63, 94, 0.1); color: var(--status-danger); }
        .tag-warning { background: rgba(245, 158, 11, 0.1); color: var(--status-warning); }
        .tag-info { background: rgba(99, 102, 241, 0.1); color: var(--status-info); }
    ...
    <div class="admin-main-content hide-native-scrollbar">
        ...
        <div class="dash-header">
            <div class="dash-header-left">
                ...
                <div>
                    <span class="dash-breadcrumb">Dashboard > Withdrawals</span>
            ...
            <div class="d-flex gap-2">
                ...
                <button class="btn-modern btn-primary-modern" onclick="exportPDF('withdraw-records', 'table')"><i class='bx bxs-file-pdf'></i> Export PDF</button>
            </div>
        </div>
                ...
                <tbody>
                    ...
                    ?>
                         <tr onclick="window.location.href='manager.php?uniq-id=<?php echo $request_uniq_id; ?>'">
                            ...
                            <td style="font-weight: 800; color: var(--text-main);"><?php echo htmlspecialchars($row['tbl_user_id']); ?></td>
                            <td style="color: var(--status-info); font-weight: 800;">₹<?php echo number_format($row['tbl_withdraw_amount'], 2); ?></td>
                            <td style="font-size: 12px;"><?php echo htmlspecialchars($row['tbl_time_stamp']); ?></td>
