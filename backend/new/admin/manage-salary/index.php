...
<head>
  ...
  <title><?php echo $APP_NAME; ?>: Salary</title>
    ...
    <div class="row-view sb-view">
      ...
      <div class="w-100 h-100vh pd-10 br-all ovflw-y-scroll hide-native-scrollbar">
        ...
        <div class="w-100 row-view j-start mg-t-20">
            ...
            <h1 class="mg-l-15">All Salaries</h1> 
        </div>
           
        <div class="pd-10 mg-t-30 bx-shdw br-r-5">

            <a href="create-salary" class="txt-deco-n cur-pointer pd-5-10 mg-l-5 cl-white br-r-5 bg-primary"><i class='bx bx-plus'></i>&nbsp;Create Salary</a>
