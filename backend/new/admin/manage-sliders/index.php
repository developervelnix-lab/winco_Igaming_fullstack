    ...
    <div class="row-view sb-view">
      ...
      <div class="w-100 h-100vh pd-10 br-all ovflw-y-scroll hide-native-scrollbar">
        ...
        <div class="w-100 row-view j-start mg-t-20">
            ...
            <h1 class="mg-l-15">All Sliders</h1> 
        </div>
           
        <div class="pd-10 mg-t-30 bx-shdw br-r-5">

            <a href="create-slider" class="txt-deco-n cur-pointer pd-5-10 mg-l-5 cl-white br-r-5 bg-primary"><i class='bx bx-plus'></i>&nbsp;Add Slider</a>
              ...
              if (mysqli_num_rows($recharge_records_result) > 0){
                ...
                ?>
                 <tr>
	               ...
	               <td><?php echo substr($row['tbl_slider_img'],0,30).'...'; ?></td>
	               <td><?php echo substr($row['tbl_slider_action'],0,20).'...'; ?></td>
	               <td><a onclick="deleteItem('<?php echo $row['id']; ?>')" class="white-space-nw txt-deco-n cur-pointer pd-5-10 cl-white br-r-5 bg-primary bg-red" target="_blank">Delete</a></td>
	             </tr>
