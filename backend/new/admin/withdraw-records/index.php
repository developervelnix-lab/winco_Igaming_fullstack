...
<div class="mh-100vh w-100">
    ...
    <div class="row-view sb-view">
      ...
      <div class="w-100 h-100vh pd-10 br-all ovflw-y-scroll hide-native-scrollbar">
        <p>Dashboard > Withdraw Records</p>
        ...
        <div class="w-100 row-view j-start mg-t-20">
            ...
            <h1 class="mg-l-15">Withdraw Records</h1> 
        </div>
        ...
        <div class="pd-10 mg-t-30 bx-shdw br-r-5">
            ...
            <form action="<?php $_SERVER['PHP_SELF'] ?>" method="POST">
                ...
                <div class="row-view j-start">
                 ...
                 <button class="filter_btn action-btn br-r-5 ft-sz-15 pd-10-15 mg-l-10" onclick="exportPDF('withdraw-records', 'withdraw')" type="button">Export PDF</button>
                </div>
            ...
            <table id="withdraw" class="cus-tbl mg-t-10 bg-white">
	          <tr>
