  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center mb-6 pl-2">
        <h2
          className="text-black dark:text-white text-sm sm:text-lg font-bold tracking-tight uppercase whitespace-nowrap"
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            onClick={openPopup}
            className="flex items-center gap-1.5 sm:gap-2 px-2.5 sm:px-4 py-1.5 sm:py-2 rounded-xl text-[10px] sm:text-xs font-bold uppercase transition-all duration-500 shadow-lg hover:shadow-brand/20 active:scale-95 group overflow-hidden relative whitespace-nowrap shrink-0"
            style={{
              ...
              >
                ...
                {hoveredGame === game["Game UID"] && (
                  <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                    <div
                      className="rounded-full p-4 transform scale-90 group-hover:scale-110 transition-transform duration-300 shadow-xl"
                      style={{ background: COLORS.brandGradient }}
                    >
                      <FaPlay className="text-black dark:text-white" size={20} />
                    </div>
                  </div>
                )}
              </div>
