...
const BrandingBanner = () => {
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl md:rounded-[2.5rem] py-6 px-6 md:py-12 md:px-16 border border-black/5 dark:border-white/5 shadow-[0_40px_80px_-20px_rgba(0,0,0,0.7)] group" style={{ backgroundColor: COLORS.bg2 }}>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        ...
        <motion.h2 
          ...
          className="w-full text-[clamp(0.6rem,3.5vw,3rem)] md:text-4xl lg:text-5xl font-black text-black dark:text-white leading-none uppercase tracking-tighter whitespace-nowrap"
        >
      ...
      <div className="absolute top-0 left-0 w-20 h-20 border-l border-t border-black/10 dark:border-white/10 rounded-tl-2xl md:rounded-tl-[2.5rem] pointer-events-none"></div>
      <div className="absolute bottom-0 right-0 w-20 h-20 border-r border-b border-black/10 dark:border-white/10 rounded-br-2xl md:rounded-br-[2.5rem] pointer-events-none"></div>
    </div>
  );
};
